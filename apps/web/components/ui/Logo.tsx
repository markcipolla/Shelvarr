...
export function Logo({ className }: { className?: string }) {
  ...
  return (
    <svg className={className} viewBox="0 0 64 64" aria-hidden="true">
      <defs>
        <linearGradient id={gradient} x1="0.21" y1="0.09" x2="0.79" y2="0.91">
          <stop offset="0" stopColor="#8B5E3C" />
          <stop offset="1" stopColor="#5C3D26" />
        </linearGradient>
      </defs>
      <rect width="64" height="64" rx="14.5" fill={`url(#${gradient})`} />
      <path
        d="M0 14.5A14.5 14.5 0 0 1 14.5 0H49.5A14.5 14.5 0 0 1 64 14.5V15.5A14.5 14.5 0 0 0 49.5 1H14.5A14.5 14.5 0 0 0 0 15.5Z"
        fill="#FFF"
        fillOpacity={0.15}
      />
      <svg x="16.1" y="12.25" width="31.8" height="39.3" viewBox="12 5 76 90">
        <path fill="#F5F1EB" d={STACK} />
      </svg>
    </svg>
  );
}
