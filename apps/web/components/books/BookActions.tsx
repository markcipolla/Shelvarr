      ...
      <div className="space-y-2">
        {isEpub && (
          <button
            ...
            disabled={loading}
            className="flip-book-trigger w-full bg-green-600 hover:bg-green-700 text-white px-4 py-2.5 rounded-lg font-medium transition-colors disabled:opacity-50 flex items-center justify-center gap-3"
          >
            <FlipBook src={book.coverUrl} title={book.title || getFilenameFromPath(book.filePath)} />
            Read
          </button>
        )}
