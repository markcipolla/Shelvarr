module.exports = [
"[project]/lib/actions/data:9029b6 [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$actions$2f$data$3a$9029b6__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/lib/actions/data:9029b6 [app-ssr] (ecmascript) <text/javascript>");
'use client';
;
;
;
...
function AuthorCard({ author }) {
    ...
    const handleClick = async ()=>{
        if (author.authorId) {
            ...
            setLoading(true);
            const created = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$actions$2f$data$3a$9029b6__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getOrCreateAuthor"])(author.name);
            setLoading(false);
...
//# sourceMappingURL=_ab08f261._.js.map