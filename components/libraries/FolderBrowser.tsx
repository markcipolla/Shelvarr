  ...
  return (
    <div className="mt-2 max-h-64 overflow-auto border border-shelvarr-border rounded-lg bg-shelvarr-bg">
      <div className="p-2">
        ...
        {!loading && !error && data && (
          <>
            <div className="flex items-center justify-between gap-2 p-2 bg-shelvarr-surface rounded mb-2">
...
function FolderIcon() {
  return (
    <svg className="w-4 h-4 text-shelvarr-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
